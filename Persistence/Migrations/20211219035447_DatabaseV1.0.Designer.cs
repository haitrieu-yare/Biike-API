...
namespace Persistence.Migrations
{
    ...
    [Migration("20211219035447_DatabaseV1.0")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AdvertisementAddress", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdvertisementAddressId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.AdvertisementImage", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AdvertisementImageId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.Bike", b =>
                {
                    ...
                    b.Property<string>("DrivingLicenseBackPicture")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DrivingLicenseFrontPicture")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.BikeAvailability", b =>
                {
                    b.Property<int>("BikeAvailabilityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BikeAvailabilityId"), 1L, 1);
                    ...
                    b.HasKey("BikeAvailabilityId");

                    b.HasIndex("StationId");

                    b.HasIndex("UserId");

                    b.ToTable("BikeAvailability");
                });
            ...
            modelBuilder.Entity("Domain.Entities.MomoTransaction", b =>
                {
                    b.Property<int>("MomoTransactionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MomoTransactionId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.Sos", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.Station", b =>
                {
                    ...
                    b.Property<bool>("IsCentralPoint")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entities.Trip", b =>
                {
                    ...
                    b.Property<int?>("FirstPersonArrivalId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("FirstPersonArrivalTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int?>("SecondPersonArrivalId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("SecondPersonArrivalTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Entities.TripTransaction", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TripTransactionId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("IsKeNowAvailable")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Entities.VoucherAddress", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VoucherAddressId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.VoucherCategory", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VoucherCategoryId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.VoucherCode", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VoucherCodeId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.VoucherImage", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VoucherImageId"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.Report", b =>
                {
                    b.HasOne("Domain.Entities.User", "UserOne")
                        .WithMany("UserOneReports")
                        .HasForeignKey("UserOneId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Entities.User", "UserTwo")
                        .WithMany("UserTwoReports")
                        .HasForeignKey("UserTwoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("SosList");

                    b.Navigation("UserAddresses");

                    b.Navigation("UserOneIntimacies");

                    b.Navigation("UserOneReports");

                    b.Navigation("UserTwoIntimacies");

                    b.Navigation("UserTwoReports");
